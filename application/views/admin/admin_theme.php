      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-user"></i> <span>Data Import</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('lihat_data'); ?>"><i class="fa fa-circle-o"></i> Lihat Data</a></li>
                <li><a href="<?php echo site_url('import_data'); ?>"><i class="fa fa-circle-o"></i> Import Data</a></li>
                <li><a href="<?php echo site_url('diagram_pie'); ?>"><i class="fa fa-circle-o"></i> Diagram</a></li>
              </ul>
            </li>
          </ul>
        </section>
